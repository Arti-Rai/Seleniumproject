...
WebDriver driver;
JavascriptExecutor js = (JavascriptExecutor) driver; @BeforeMethod
public void setUp() {
...
driver.manage().timeouts().implicitlyWait(1,TimeUnit.SECONDS); driver.findElement(By.xpath("//a[@id='srchbar']")).click();
Thread.sleep(1000);
...
// Book table Script Thread.sleep(1000);
